...
def build_model(input_shape1,input_shape2):
    ...
    x = Conv2D(1024, (4, 4), activation='relu', padding="same")(inputs1)
...
history = model.fit([X1_train, X2_train], y_train, epochs=epoch, batch_size=batch_size, validation_data=([X1_val,X2_val], y_val),
...
plt.legend()
# 保存图像
plt.savefig('./figure/CNN_dense_cds_1.png')